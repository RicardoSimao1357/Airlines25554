...
namespace Airlines25554.Migrations
{
    ...
    [Migration("20221010182922_AddPurchasedTickets")]
    partial class AddPurchasedTickets
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Airlines25554.Data.Entities.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Airlines25554.Data.Entities.Flight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("BusyEconomicSeats")
                        .HasColumnType("int");

                    b.Property<int>("BusyExecutiveSeats")
                        .HasColumnType("int");

                    b.Property<int>("BusyFirstClassSeats")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Airlines25554.Data.Entities.Passenger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Airlines25554.Data.Entities.TicketPurchased", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Airlines25554.Data.Entities.Flight", b =>
                {
                    b.HasOne("Airlines25554.Data.Entities.AirPlane", "AirPlane")
                        .WithMany()
                        .HasForeignKey("AirPlaneId");

                    b.HasOne("Airlines25554.Data.Entities.Airport", "From")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Airlines25554.Data.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
